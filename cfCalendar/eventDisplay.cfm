                                        ...
                                        <cfloop array="#events#" index="event">
                                            <tr>
                                                <td>
                                                    ...
                                                    <cfelseif event.getStr_priority() EQ "Low">
                                                        <cfset str_event_color = "green"> <!-- Green for Low Priority -->
                                                    </cfif>
                                                    <span class="event-dot" style="background-color: #str_event_color#"></span>
                                                    #event.getStr_event_title()#
                                                </td>
                                                <td>#DateFormat(event.getDt_event_date(), "mmm dd, yyyy")#</td>
                                                <td>#event.getStr_description()#</td>
                                                <td>
                                                    <cfif event.getStr_recurrence_type() NEQ "none">
                                                        <span class="badge bg-info">
                                                            #UCase(event.getStr_recurrence_type())# 
                                                            (#event.getInt_recurring_duration()# 
                                                            <cfif event.getStr_recurrence_type() EQ "daily">days
                                                            <cfelseif event.getStr_recurrence_type() EQ "weekly">weeks
                                                            <cfelseif event.getStr_recurrence_type() EQ "monthly">months
                                                            </cfif>)
                                                        </span>
                                                    <cfelse>
                                                ...
                                                <td>
                                                    <form action="addEvent.cfm" method="post" style="display: inline-block; margin-right: 5px;">
                                                        ...
                                                        <input type="hidden" name="selectedDate" value="#DateFormat(event.getDt_event_date(), 'yyyy-mm-dd')#">
